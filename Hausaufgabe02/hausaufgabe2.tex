...
\begin{document}
	...
	\section{Prozesse und Threads}
		...
		\item[d.] \hspace{1pt}
			...
			\newpage
			\textbf{Zustände:}\\ 
			Rechenfähig-Der Prozess befindet sich im Hauptspeicher und erwartet
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.9]{gssHA2-3.png}
...
Die Anzahl der Leseaufträge an den Speicher in der obigen Rechnung beträgt 16. In den Speicher geschrieben wird 11 mal. Damit ergiebt sich eine Berechnungszeit von $16 \cdot 20 + 11 = 331$ Additionen.
\end{document}
