...
Die \textbf{Zugriffskontrolle} hingegen gibt einem identifizierten Kommunikationspartner nur den Zugriff auf Objekte, für die er Zugriffsrechte hat.\\
\item
...
\item
Für eine Zugriffskontrolle muss der Nutzer des Systems identifiziert sein, um ihm Zugriffsrechte zuordnen zu können.\\
\end{enumerate}

\subsection*{1.4 Realisierung eines Online-Ticket-Verkaufs}
\begin{enumerate}
\item
\textbf{Rolle}: Außenstehender (Kunde)\\
\textbf{Verbreitung}: Onlinetransaktion(1), Ticketübermittlung(2), andere Kunden(3), Alte Codes von Tickets auswerten(4)\\
\textbf{Verhalten}: (1,2) passiv beobachtend, (3,4) aktiv beobachtend\\
\textbf{Rechenkapazität}: beschränkt.\\
\item
...
\section{Rechnersicherheit}
1.
\lstinputlisting[language=java, caption=Timer.java]{Timer.java}
3.\\
